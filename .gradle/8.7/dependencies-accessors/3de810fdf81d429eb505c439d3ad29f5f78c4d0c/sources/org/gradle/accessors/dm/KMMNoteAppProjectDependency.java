...
@NonNullApi
public class KMMNoteAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KMMNoteAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
