...
*/
- (void)deleteNodeByIdId:(int64_t)id completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteNodeById(id:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SqlDelightNodeDataSource")))
@interface SharedSqlDelightNodeDataSource : SharedBase <SharedNoteDataSource>
...
@required
@property (readonly) SharedNoteQueries *noteQueries __attribute__((swift_name("noteQueries")));
@end
...
@interface SharedNoteQueries : SharedRuntimeTransacterImpl
- (instancetype)initWithDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("init(driver:)"))) __attribute__((objc_designated_initializer));
